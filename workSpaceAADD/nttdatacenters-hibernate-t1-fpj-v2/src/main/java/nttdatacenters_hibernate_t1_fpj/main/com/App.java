...
public class App {
    public static void main(String[] args) {
        ...
        newCustomer.setFirstSurname("Doe");
        ...
        System.out.println("Retrieved customer: " + retrievedCustomer.getName() + " " + retrievedCustomer.getFirstSurname());
        ...
        customerService.searchCustomersByNameAndSurname("John", "Doe", null)
                .forEach(c -> System.out.println(c.getName() + " " + c.getFirstSurname()));
