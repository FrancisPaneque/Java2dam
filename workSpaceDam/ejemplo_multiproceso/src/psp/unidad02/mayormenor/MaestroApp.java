package psp.unidad02.mayormenor;
...
public class MaestroApp {
  ...
  private static final int[] DATOS_PRUEBA = {54, 66, 37, 95, 97, 19, 80, 80, 22, 69, 77, 23, 31, 18, 30, 6};
  ...
  public static void main(String[] args) throws Exception {
    ...
    for (Process proceso: procesos) {
      ...
      for (int i = vuelta * (DATOS_PRUEBA.length / PROCESOS); i < ((vuelta + 1) * (DATOS_PRUEBA.length / PROCESOS)); i++) {
