...
import hlc.ud04.controllAcceso.controlacceso.ControlAccesoMascara;
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    SistemaSeguridad sistemaSeguridad = new SistemaSeguridadPassword(new AutenticadorPassword(),new ControlAccesoMascara());
