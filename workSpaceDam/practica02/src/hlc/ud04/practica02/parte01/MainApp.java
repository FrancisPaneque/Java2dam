package hlc.ud04.practica02.parte01;
...
import hlc.ud04.practica02.parte01.controlacceso.ControlAccesoSqlite;
...
public class MainApp {
  ...
  public static void main(String[] args) {
    ...
    SistemaSeguridad sistemaSeguridad = new SistemaSeguridadPasswordSqlite(new AutenticadorPasswordSqlite(DATABASE_PATH), new ControlAccesoSqlite(DATABASE_PATH));
