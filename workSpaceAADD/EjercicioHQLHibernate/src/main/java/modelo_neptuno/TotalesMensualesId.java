...
public class TotalesMensualesId implements java.io.Serializable {
	...
	public TotalesMensualesId(Integer anio, Integer mes, Date fecha, BigInteger cargo, Double importe, Double total,
			long numPedidos) {
		this.anio = anio;
		this.mes = mes;
		this.fecha = fecha;
	...
	public boolean equals(Object other) {
		...
		return ((this.getAnio() == castOther.getAnio())
				|| (this.getAnio() != null && castOther.getAnio() != null && this.getAnio().equals(castOther.getAnio())))
